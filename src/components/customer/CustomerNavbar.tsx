...
function CustomerNavbar() {
    // here need to manage a global state
            ...
            <header className="bg-white">
                <div className="container mx-auto px-4 py-2 flex items-center">
                    <div className="mr-auto md:w-48 flex-shrink-0">
                        <img className="h-14 md:h-16" src="/images/logo.png" alt="" />
                    </div>
                    <div className="w-full max-w-xs xl:max-w-lg 2xl:max-w-2xl bg-gray-100 rounded-md hidden xl:flex items-center">
                        <select className="bg-transparent uppercase font-bold text-sm p-4 mr-4 outline-none" name="" id="">
                            <option>all categories</option>
                            <option>Category 01</option>
                            <option>Category 02</option>
                        </select>
                        <input className="border-l border-gray-300 bg-transparent font-semibold text-sm pl-4 w-full outline-none" type="text" placeholder="I'm searching for ..." />
                    ...
                    <nav className="contents">
                        <ul className="ml-4 xl:w-48 flex items-center justify-end">
                            <li className="ml-2 lg:ml-4 relative inline-block">
                                <a className="" href="/customer/profile">
                            ...
                            <li className="ml-2 lg:ml-4 relative inline-block">
                                <a className="" onClick={() => setShowCart(!showCart)}>
				...
				<div className="pt-6">
					<a className="block px-4 py-3 mb-3  text-xs text-center font-semibold leading-none bg-yellow-400 hover:bg-gray-100 rounded-xl" href="#">Sign in</a>
